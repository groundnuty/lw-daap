...
<div class="record-details">
    ...
    <div class="col-sm-12 col-md-9">
      <div class="panel-list-wrapper">
        ...
        <div class="row" style="margin-bottom: 30px;">
          <div class="col-md-3">
            <span style="font-size: 1.3em; font-weight: 700; ">
              <i class="fa fa-calendar fa-fw"></i> Publication Date
            </span>
          </div>
          <div class="col-md-9">
            {{ daap_record.publication_date }}
          </div>
        </div>
        {% endif %}
        ...
        <div class="row" style="margin-bottom: 30px;">
          <div class="col-md-3">
            <span style="font-size: 1.3em; font-weight: 700; ">
              <i class="fa fa-pencil fa-fw"></i> Access Rights
            </span>
          </div>
          <div class="col-md-9">
            {{ render_access_rights(daap_record) }}
          </div>
        </div>
        {% endif %}
        ...
        <div class="row" style="margin-bottom: 30px;">
          <div class="col-md-3">
            <span style="font-size: 1.3em; font-weight: 700; ">
              <i class="fa fa-fw fa-laptop"></i> OS
            </span>
          </div>
          <div class="col-md-9">
            {{ bfe_daap_req_names(bfo, req_id=daap_record.os) }}
          </div>
        </div>
        <div class="row" style="margin-bottom: 30px;">
          <div class="col-md-3">
          ...
          <div class="col-md-9">
            {{ bfe_daap_req_names(bfo, req_id=daap_record.flavor) }}
          </div>
        </div>
        <div class="row" style="margin-bottom: 30px;">
          <div class="col-md-3">
            <span style="font-size: 1.3em; font-weight: 700; ">
              <i class="fa fa-fw fa-laptop"></i> Enviroment
            </span>
          </div>
          <div class="col-md-9">
            {{ bfe_daap_req_names(bfo, req_id=daap_record.app_env) }}
          </div>
        </div>
  ...
  {% endblock %}
  {% endif %}
</div>{% from "format/record/record_macros.tpl" import render_authors,
                                                 render_access_rights,
                                                 render_deposition_type,
                                                 render_rel_input,
                                                 open_panel_section,

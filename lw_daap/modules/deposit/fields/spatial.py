...
def validate_spatial(form, field):
    """Deprecated."""
    import warnings
...
class SpatialField(WebDepositField, StringField):
    ...
    def __init__(self, **kwargs):
        ...
        defaults = dict(
            icon='book',
            export_key='spatial.spatial',
            widget_classes="form-control"
            # FIXMEvalidators=[validate_spatial]
        )
        defaults.update(kwargs)
        super(SpatialField, self).__init__(**defaults)

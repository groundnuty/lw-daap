	...
	function depositForm() {
		...
		function handle_response(data) {
			...
			if($('#instrument').val()!= '-1'){
				...
				$('#access_groups .field-list-element').show();
				$('#access_groups .field-list-element .remove-element').hide();
				$('#access_groups .twitter-typeahead').hide();
				$('#access_groups .field-desc').hide();
			} else {
			    setTimeout(function() {
				...
				$('#access_groups .field-list-element').show();
				$('#access_groups .field-list-element .remove-element').show();
